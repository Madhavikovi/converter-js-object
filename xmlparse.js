...
//-------------------Hard coded input xml data-------------
//Quite big xml data
//var xmlText = "<data>   <title>Hello, world</title>    <description>     A bit of example XML for testing   </description>    <attr item='attr' href='http://google.com' />    <item>     <header>title</header>     <desc>desc</desc>     <xml:namespaced>test</xml:namespaced>   </item>    <item>     <header>another title</header>     <desc>desc 2</desc>     <xml:namespaced>text</xml:namespaced>   </item> </data>";

//Simple xml data
//var xmlText = "<data> <title>Hello, world</title>	<item>    <header>title</header>    <desc>desc</desc>    <xml:namespaced>test</xml:namespaced>  </item><item>    <header>another title</header>    <desc>desc 2</desc>    <xml:namespaced>text</xml:namespaced>  </item></data>";
